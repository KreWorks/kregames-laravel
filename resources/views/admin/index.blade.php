                                    ...
                                    <div class="nofity-list">
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="{{ asset('srtdash/assets/images/author/author-img1.jpg') }}" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
                                        ...
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="{{ asset('srtdash/assets/images/author/author-img2.jpg') }}" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
                                        ...
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="{{ asset('srtdash/assets/images/author/author-img3.jpg') }}" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
                                        ...
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="{{ asset('srtdash/assets/images/author/author-img4.jpg') }}" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>

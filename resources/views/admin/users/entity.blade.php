<td class="align-middle"><img src="/{{ $data->avatar ? $data->avatar->path : '' }}" style="width:50px; height:50px;" alt="icon"></td>
...
<td class="align-middle">
    <ul class="list-inline" style="margin-bottom:0px;">
        <li class="list-inline-item">
            <form action="{{route('admin.users.edit', $data->id) }}" method="GET">
